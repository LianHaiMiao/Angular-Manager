...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        function d() {
                            try { document.documentElement.doScroll("left") } catch (e) { setTimeout(d, 1); return }
                            a()
                        }
                        c.push(b);
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                function m(a, e, A, l) { a = { name: b, sender: this, editor: a, data: e, listenerData: k, stop: A, cancel: l, removeListener: u }; return !1 === d.call(g, a) ? !1 : a.data }
    ...
    (function() {
        var a = [],
            ...
            m = function(a, e) { return "#" == e[0] ? String.fromCharCode(parseInt(e.slice(1), 10)) : l[e] };
        ...
        CKEDITOR.tools = {
            ...
            cssStyleToDomStyle: function() {
                ...
                return function(a) { return "float" == a ? e : a.replace(/-./g, function(a) { return a.substr(1).toUpperCase() }) }
            }(),
            ...
            transformPlainTextToHtml: function(a, e) {
                ...
                if (!b) {
                    ...
                    if (d.test(c)) var q = "\x3c" + l + "\x3e",
                        m = "\x3c/" + l + "\x3e",
                        c = q + c.replace(d, function() { return m + q }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            indexOf: function(a, e) {
                if ("function" == typeof e)
                    for (var b = 0, c = a.length; b < c; b++) { if (e(a[b])) return b } else {
            ...
            tryThese: function() { for (var a, e = 0, b = arguments.length; e < b; e++) { var c = arguments[e]; try { a = c(); break } catch (l) {} } return a },
    ...
    (function() {
        ...
        function c(a) { for (var b = 0, c = 0, e = k[a].length; c < e; c++) b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function w(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }!a && (a = this.getWindow());
                r = a.getDocument();
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return (!b || !g.equals(a)) && (!E || !a.equals(E)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) }
            }
            var k = a ? this._.guardRTL : this._.guardLTR;
            v = h ? function(a, b) { return !1 === k(a, b) ? !1 : h(a, b) } : k;
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            m = function(a) { return k(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        CKEDITOR.dom.walker.ignored =
            function(a) { return function(b) { b = g(b) || k(b) || l(b); return !!(a ^ b) } };
    ...
    (function() {
        ...
        function b() {
            ...
            return function(f) { return c(f) || b(f) ? !0 : d(f) && !a ? a = !0 : f.type == CKEDITOR.NODE_TEXT && (f.hasAscendant("pre") || CKEDITOR.tools.trim(f.getText()).length) || f.type == CKEDITOR.NODE_ELEMENT && !f.is(g) ? !1 : !0 }
        }
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var q = function(a, b) {
                            ...
                            var c = new CKEDITOR.dom.walker(c),
                                e;
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; e =
                                c.next();) {
                                        ...
                                        if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(J)) p = null;
                                                ...
                                                for (var E = p.$.getElementsByTagName("*"), C = 0, u; u =
                                                    E[C++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[u.nodeName.toLowerCase()]) { p = null; break }
                                            p && (z = !!J.length)
                                        } else p = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            ...
                            I = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (B) { if (B.equals(a)) { B = null; return } } else B = a;
                                else if (B) return;
                                var b = N(a);
                                b || (m = a);
                                return b
                            },
                            f = function(a) { var b = I(a);!b && a.is && a.is("br") && (O = a); return b };
                        h.guard = I;
                        h = h.lastBackward();
                        m = m || k;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            var F = CKEDITOR.dom.walker.whitespaces(),
                                K = CKEDITOR.dom.walker.bookmark();
                            h.evaluator = function(a) { return !F(a) && !K(a) };
    ...
    (function() {
        ...
        function A(a, b) { var c = a.match(I[b]); return c ? Y(c[1]) : null }
        ...
        function H(a) { if (!a) return !1; if (!0 === a) return !0; var b = D(a); return function(c) { return c in a || b && c.match(b) } }
                ...
                if ("br" == b) a.previous && !v(a.previous) && (b = t(), b.insertBefore(a)), a.next && !v(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren();
                    ...
                    b: {
                        ...
                        for (var p = 0, f = d.length, n; p < f; ++p)
                            if (n = d[p], n.type == CKEDITOR.NODE_ELEMENT && !h[n.name]) { h = !1; break b }
                        h = !0
                    }
        ...
        function p(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (h = c[d], !(h.check && !a.check(h.check, !1) || h.left && !h.left(b))) { h.right(b, G); break }
        }
        ...
        function n(a, b) {
            ...
            for (p in d)
                if ("class" == p)
                    for (c = d[p].split(/\s+/), n = a.classes.join("|"); e = c.pop();) { if (-1 == n.indexOf(e)) return !1 } else if (a.attributes[p] != d[p]) return !1;
            for (f in h)
                if (a.styles[f] !=
                    h[f]) return !1;
            return !0
        ...
        function y(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }

        function z(a) { return function(b) { return n(b, a) } }

        function J(a) { return function(b, c) { c[a](b) } }
        var E = CKEDITOR.dtd,
                        ...
                        x = function(b) {
                            if (a[b]) A(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, r(b, !0) } : (e.$.onload = function() { setTimeout(function() { r(b, !0) }, 0) }, e.$.onerror = function() { r(b, !1) }));
    ...
    (function() {
        ...
        function d() { do var a = "editor" + ++x; while (CKEDITOR.instances[a]); return a }
        ...
        function g(a, b, c) { if (b) { var d, f, h = a.commands; for (f in h) d = h[f], (c || d.contextSensitive) && d.refresh(a, b) } }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, l) {
                ...
                function u() { for (; H.length;) A(H.shift(), t) }
                ...
                function x(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 }
                ...
                D.onTagOpen = function(f, n, e, g) {
                    ...
                    if (a(n)) w.push(n);
                        ...
                        if ("pre" == f) h = !0;
                        else { if ("br" == f && h) { t.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (v = !0) }
                        if ("br" == f) H.push(n);
                        else {
                ...
                D.onTagClose = function(a) {
                    for (var b = w.length - 1; 0 <= b; b--)
                        if (a == w[b].name) { w.splice(b, 1); return }
    ...
    (function() {
        ...
        function d(b, c, d, g) { var k, l; for (k in c)(l = b[k]) || (l = b[k] = new a), l.add(c[k], d, g) }
    ...
    (function() {
        ...
        function e(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + x(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }

        function A(a) { return a.replace(O, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function x(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function q(a, b) {
            ...
            for (var e = 0; e < d.length; e++) a = a.replace(d[e], function(a) { a = a.replace(f, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, h) { return "\x3c" + c + d + "\x3e" + D(x(h), b) + "\x3c/" + c + "\x3e" })
        }
    ...
    (function() {
        ...
        CKEDITOR.template = function(g) {
            if (a[g]) this.output = a[g];
                ...
                var k = g.replace(b, "\\$1").replace(c, "\\n").replace(f, "\\r").replace(d, function(a, b) { return "',data['" + b + "']\x3d\x3dundefined?'{" + b + "}':data['" + b + "'],'" });
    ...
    (function() {
        function a(a) {
            ...
            k(b, e.block, n) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), n = new CKEDITOR.dom.walker(e), n.guard = function(a) { return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly() }, !n.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) &&
        ...
        function g(a) {
            function b(a) { return function(b, h) { h && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(h || !c(b) || a && x(b))) return !1 } }
            ...
            proto: {
                ...
                insertElement: function(a, b) {
                    ...
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a,
                        CKEDITOR.POSITION_AFTER_END), f && ((f = a.getNext(function(a) { return c(a) && !x(a) })) && f.type == CKEDITOR.NODE_ELEMENT && f.is(CKEDITOR.dtd.$block) ? f.getDtd()["#"] ? b.moveToElementEditStart(f) : b.moveToElementEditEnd(a) : f || e == CKEDITOR.ENTER_BR || (f = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? "div" : "p"), b.moveToElementEditStart(f))));
                    d.selectRanges([b]);
                    m(this)
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$) h = !0;
                                ...
                                if (CKEDITOR.env.webkit && (h = c.getDocument().getActive()) && h.equals(c) && !d.anchorNode) { h = !0; break a }
                                h = void 0
                            }
        ...
        q = function() {
            ...
            function f(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) }
                    ...
                    if (!m.dontMoveCaret) {
                        for (M = f(D); M && a(M) && !M.is(E.$empty);) {
                            if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (e(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { S = null; break }
                                S = D.clone();
    ...
    (function() {
        ...
        function c(a) { return H(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function l(a, b) { return b ? a.replace(D, function(a, b) { return b ? " " : "" }) : a.replace(x, "") }
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                if (CKEDITOR.env.ie || m) A ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() {
                    e.lockSelection(B);
                    q = 1
                }, null, null, -1), g.attachListener(g, "mousedown", function() { q = 0 });
            ...
            e.on("key", function(a) { if ("wysiwyg" == e.mode) { var b = e.getSelection(); if (b.isFake) { var c = t[a.data.keyCode]; if (c) return c({ editor: e, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        });
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function() { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = A ? this.document.$.selection : this.document.getWindow().$.getSelection() },
            getType: A ? function() {
                var a = this._.cache;
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < g;) try {
                            h = f[0 < n ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length,
                                m = h), f = h
                        } catch (K) { return { container: d, offset: a(f) } }
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && v[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
    ...
    (function() {
            ...
            if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0;
                        ...
                        if (x && r.data("cke-bookmark")) { r = r.getNextSourceNode(!0); continue }
        ...
        function r(a, b) {
            ...
            for (var d = 0; d < a.length; d++) {
                var e = a[d],
                    ...
                    e = A(e, /^[ \t]*\n/, ""),
                    e = A(e, /\n$/, ""),
                    e = A(e, /^[ \t]+|[ \t]+$/g, function(a, b) { return 1 == a.length ? "\x26nbsp;" : b ? " " + CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) : CKEDITOR.tools.repeat("\x26nbsp;", a.length - 1) + " " }),
                    e = e.replace(/\n/g, "\x3cbr\x3e"),
        ...
        function v(a,
            b) { for (var c in a) a[c] = a[c].replace(C, function(a, c) { return b[c] }) }
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? k : null; return this.removeFromRange(a) },
                ...
                if (m.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!k && (u = m.getName(),
                        ...
                        if (u = !g && "div" == u) {
                            a: {
                                u = m.getChildren();
                                for (var e = 0, A = u.count(); e < A; e++) { var r = u.getItem(e); if (r.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[r.getName()]) { u = !0; break a } }
                                u = !1
                            }
                            u = !u
                        }
    ...
    (function() {
                ...
                for (var c in b.contents)
                    if (b.contents[c]) {
                        var a = b.contents[c],
                            ...
                            e = a.requiredContent,
                            f = 0;
                        if (d) { for (var g in this._.contents[a.id]) { var h = this._.contents[a.id][g]; "hbox" != h.type && "vbox" != h.type && h.getInputElement() && (h.requiredContent && !this._.editor.activeFilter.check(h.requiredContent) ? h.disable() : (h.enable(), f++)) }!f || e && !this._.editor.activeFilter.check(e) ? d[0].addClass("cke_dialog_tab_disabled") : d[0].removeClass("cke_dialog_tab_disabled") }
                    }
        ...
        var aa = { resizable: CKEDITOR.DIALOG_RESIZE_BOTH, minWidth: 600, minHeight: 400, buttons: [CKEDITOR.dialog.okButton, CKEDITOR.dialog.cancelButton] },
            ...
            E = function(a, b, c, d, e) {
                if (c) { for (var f = 0, g; g = a[f]; f++) { if (g.id == c) return a.splice(f, 0, b), b; if (d && g[d] && (g = E(g[d], b, c, d, !0))) return g } if (e) return null }
                a.push(b);
                return b
            },
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                    var b = a.data.dataValue,
                        c = CKEDITOR.dtd.$block; - 1 < b.indexOf("Apple-") && (b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != a.data.type && (b = b.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi, function(a, b) { return b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;") })), -1 < b.indexOf('\x3cbr class\x3d"Apple-interchange-newline"\x3e') &&
            ...
            a.ui.addRichCombo(b, {
                ...
                onClick: function(b) {
                    ...
                    if (c && b != c) {
                        ...
                        if (e.collapsed) {
                            var d = a.elementPath(),
                                g = d.contains(function(a) { return k.checkElementRemovable(a) });
                            if (g) {
                ...
                onRender: function() {
                    a.on("selectionChange", function(b) {
                        ...
                        for (var d = 0, f; d < b.length; d++) {
                            f = b[d];
                            for (var e in m)
                                if (m[e].checkElementMatch(f, !0, a)) { e != c && this.setValue(e); return }
                        }
                        this.setValue("", l)
                    }, this)
                },
